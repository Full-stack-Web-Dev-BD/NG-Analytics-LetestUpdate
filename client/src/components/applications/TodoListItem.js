        ...
        <div className="d-flex flex-grow-1 min-width-zero">
          <CardBody className="align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
            ...
            >
              ...
              />
              <span className="align-middle "> Special Agro-industrial Processing Zone </span>
            </NavLink>
            <p className="mb-1 text-muted text-small w-15 w-xs-100">UA 10.0</p>
            <p className="mb-1 text-muted text-small w-15 w-xs-100">UA 10.0</p>
            <p className="mb-1 text-muted text-small w-15 w-xs-100">RDNG</p>
            <p className="mb-1 text-muted text-small w-15 w-xs-100">
              {item.createDate}
            </p>
            <div className="w-15 w-xs-100">
              <Badge color={item.labelColor} pill>Readiness</Badge>
            </div>
          </CardBody>
