            ...
            <NavItem >
              <div onClick={() => { }}>
                <div className="custom-control custom-radio">
                  ...
                  />
                  <label className="custom-control-label">AHVP</label>
                </div>
              </div>
            </NavItem>
            <NavItem >
              <div onClick={() => { }}>
                <div className="custom-control custom-radio">
                  <input
                    ...
                    className="custom-control-input"
                  />
                  <label className="custom-control-label">PIVP</label>
                </div>
              </div>
            </NavItem>
            <NavItem >
              <div onClick={() => { }}>
                <div className="custom-control custom-radio">
                  <input
                    ...
                    className="custom-control-input"
                  />
                  <label className="custom-control-label">PEVP</label>
                </div>
              </div>
            </NavItem>
