    ...
    <ApplicationMenu>
      ...
      >
        <div className="p-4">
          ...
          <div>
            <NavLink to="#" location={{}}>
              <Badge className="mb-1" color="outline-primary" pill>Board Approved</Badge>{' '}
            </NavLink>

            <NavLink to="#" location={{}}>
              <Badge className="mb-1" color="outline-secondary" pill>Concept Note</Badge>{' '}
            </NavLink>
            <NavLink to="#" location={{}}>
              <Badge className="mb-1" color="outline-dark" pill> Appraisal </Badge>{' '}
            </NavLink>
          </div>
        </div>
      </PerfectScrollbar>
