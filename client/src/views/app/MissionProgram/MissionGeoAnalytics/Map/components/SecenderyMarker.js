...
const SecenderyMarker = ({ selectedState }) => {
  const [myMarkers, setMyMarkers] = useState({
    features: [
      {
        geometry: {
          coordinates: [3.551223, 52.356148],
        },
        properties: {
          stateName: ' Akwa',
      ...
      {
        geometry: {
          coordinates: [10.418837, 40.758777],
        },
        properties: {
          stateName: 'Adamawa',
      ...
      {
        geometry: {
          coordinates: [7.156967, 37.336761],
        },
        properties: {
          stateName: 'Adamawa',
      ...
      {
        geometry: {
          coordinates: [9.526894, 45.762486],
        },
        properties: {
          stateName: 'Abia',
  ...
  const iconMarkup = renderToStaticMarkup(
    <i class="fas fa-circle" style={{ color: '#B9AC57' }}></i>
  );
...
export default SecenderyMarker;
