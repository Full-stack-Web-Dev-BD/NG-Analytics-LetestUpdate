...
const LendingCommitmentTableRegoin = () => {
                        ...
                        <table class="table table-bordered table-sm table-hover mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th style={{ backgroundColor: '#F7F7F7' }} className="text-center" colspan="4">EAST</th>
                                    <th className="text-center" colspan="4">NIGERIA</th>
                                    <th style={{ backgroundColor: '#F7F7F7' }} className="text-center" colspan="4">NORTH</th>
                                    <th className="text-center" colspan="4">SOUTH</th>
                                    <th style={{ backgroundColor: '#F7F7F7' }} className="text-center" colspan="4">WEST</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
...
export default LendingCommitmentTableRegoin
